...
pauseBtn.addEventListener('click', () => {
	if(document.querySelectorAll('use')[0].getAttribute('href') === '#icon-pause') {
		textPlay()
		musicPlay.play()
	} else if(document.querySelectorAll('use')[0].getAttribute('href') === '#icon-play') {
		clearInterval(time)
		clearInterval(play)
		musicPlay.pause()
	}
...
soundBtn.addEventListener('click', () => {
	if(document.querySelectorAll('use')[1].getAttribute('href') === '#icon-sound-on') {
		musicPlay.muted = false
	} else if(document.querySelectorAll('use')[1].getAttribute('href') === '#icon-sound-off') {
		musicPlay.muted = true
	}
})

settingsBtn.addEventListener('click', () => {
	document.querySelector('.wishText').classList.toggle('hide')
	if(document.querySelectorAll('.controls')[0].getAttribute('class') === 'controls') {
		textPlay()
		musicPlay.play()
	} else if (document.querySelectorAll('.controls')[0].getAttribute('class') === 'controls hide') {
		clearInterval(time)
		clearInterval(play)
		musicPlay.pause()
	}
